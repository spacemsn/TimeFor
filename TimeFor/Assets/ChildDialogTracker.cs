...
public class ChildDialogTracker : MonoBehaviour
{
    [Header("EntryPoint")]
    ...
    private void OnTransformChildrenChanged()
    {
        ...
        if (currentButton != null) { oldButton = currentButton; oldButton.GetComponent<AnswerButton>().isSelect(); }
        if (this.transform.GetChild(0) != null)
        {
            currentButton = this.transform.GetChild(0).GetComponent<Button>(); currentButton.GetComponent<AnswerButton>().isSelect();
    ...
    public void SelectObject(Button obj)
    {
        ...
        // Выбираем новый объект
        if (currentButton != null) { oldButton = currentButton; oldButton.GetComponent<AnswerButton>().isSelect(); }
        currentButton = obj; currentButton.GetComponent<AnswerButton>().isSelect();
